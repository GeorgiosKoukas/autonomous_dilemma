...
MAX_OFFSET_X = 15  # define maximum x offset
MIN_OFFSET_X = -15  # define minimum x offset
MAX_OFFSET_Y = 10  # define maximum y offset (keeping it near the ego)
MIN_OFFSET_Y = 25 # define minimum y offset (keeping it near the ego)

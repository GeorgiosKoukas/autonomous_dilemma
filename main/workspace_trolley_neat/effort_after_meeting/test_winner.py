...
class TrolleyScenario:
    def __init__(self, number_lane_1, number_lane_2, client, weather, pre_sampled_attributes, generation_spawn_locations):
        ...
        self.offset_1 = carla.Vector3D(1.5, 17, 0) #y is the distance facing the ego, x is the distance perpendicular to the ego
        self.offset_2 = carla.Vector3D(-1.5, 17, 0)
...
def get_metrics(self):
    metrics = {
        'total_harm_score': self.total_harm_score,
        'num_pedestrians_hit': len(self.collided_pedestrians),
        'total_num_pedestrians': self.number_lane_1 + self.number_lane_2,
        # add any other metrics you want to collect
    }
    return metrics        
...
if __name__ == "__main__":    
    ...
    num_scenarios = 30  # or any number of scenarios you want to test
...
for _ in range(num_scenarios):
    # Generate a random scenario. This would depend on your logic.
    ...
    results['total_pedestrians'].append(scenario.number_lane_1 + scenario.number_lane_2)
